...
<body>
   ...
   <div class="login">
      ...
      <h2 style="font-family: photoF;" class="login-header">회원가입</h2>

      <form class="login-container" action="signin_process.jsp" method="POST" onsubmit="return checkValue()" >
         <p>
         ...
         <p>
            <input style="font-family: photoF;" type="reset" name="reset" value="초기화">
            <input style="font-family: photoF;" type="submit" name="Submit" value="확인">
         </p>
      </form>
   </div>
</body>
